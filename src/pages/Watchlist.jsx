    ...
    return (
        <>
            <div className="min-vh-100">
                ...
                {
                    Object.keys(movieItems).length > 0 && Object.keys(tvItems).length > 0 &&
                    <hr className="mx-5"/>
                }
                {
                ...
                }
                {
                    ...
                    <Motion.div initial={{opacity: 0}} animate={{opacity: 1}} className="position-absolute top-50 start-50 translate-middle">
